...
memories.push("That time Dad made us milkshakes and kept the plastic from the popsicles in there.");
memories.push("Slumber parties in Pittsburg with Mom. Wine, shopping, plays. So much fun.");
memories.push("The Steelers-Ravens game. Best seats in the house.");
memories.push("Pool parties at our Jamestown house. Who can forget that huge blowup whale!");
memories.push("Mom letting Claire skinny dip at our pool in Jamestown.");
memories.push("Dad letting us drive the coolest cars in town!");
memories.push("Our epic tennis hours in Hilton Head.");
memories.push("That time the whole family was going mini golfing in HHI and Claire and Brendan took a wrong turn.");
memories.push("Relaxing and going on shows and casinos and eating our faces off on our cruises.");
memories.push("When Claire pierced her nose, and Dad didn't leave the car the whole trip.");
memories.push("2 for $22 at Vito's with Mom.");
memories.push("Weekend school shopping trips to get the best clothes before each new year.");
memories.push("Kon-O-Kwee care packages. The best.");
memories.push("Going to car shows. Checking out the new whips.");
memories.push("Girls weekend getaways to NYC.");
memories.push("Asking Mom after Dad says we couldn't do it and vice versa.");
memories.push("Dad taking me to drive for the very first time, practicing in JMU parking lots before I proved to him I was ready for the real roads.");
memories.push("Being the very first camper at camp KOK every summer!");
memories.push("Going through the Trail of Courage with Dad, he even attempted almost every obstacle.");
memories.push("Moving us in and out of college every year. We tried to also have our stuff packed up before Dad got to campus. Then there was Lindsey, freshman year...");
memories.push("Dad putting my hair up in a ponytail everyday before school. Still use the same hairbrush today.");
memories.push("Sled riding in Jamestown down that huge hill!");
memories.push("Dad always getting an extra drink on car trips, so we didn't drink all of his.");
memories.push("Bringing Mom food and eating with her at the hospital during her on-call shifts.");
memories.push("Pedicures with Mom. The best.");
memories.push("Watching Gossip Girl with Dad, and him saying every time Serena and Dan broke up he was going to quit watching the show as he yelled at the t.v. to the actors.");
memories.push("Slumber parties with Mom in her big bed when Dad was out of town.");
memories.push("You made it look so easy.");
memories.push("I cry every time I drive away.");
memories.push("What I wouldn't give for one more night, a shared casserole, all of us so young.  It was something, wasn't it.  It is something.");
memories.push("You built something wonderful.  This you should know.");
memories.push("Pounding the pavement, endless basketball games in the driveway.  It felt that way, didn't it?  And it never got old.");
memories.push("Christmas - you've got it down: the food, the gifts, the wine, the letter.  It couldn't get any better.");
